## GutenPwn Packaging Hub

Este diretório centraliza os **4 caminhos de distribuição** do GutenPwn.

- `01-pypi/` -> build e publicação PyPI (`pip install gutenpwn`)
...
- `man/` -> fonte do man page (`gutenpwn.1`)
