...
"""Environment diagnostics for GutenPwn."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="GutenPwn environment diagnostics")
    ...
    print("{}GutenPwn — Environment Doctor{}".format(_B, _R))
