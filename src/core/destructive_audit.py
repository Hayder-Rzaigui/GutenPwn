...
# -*- coding: utf-8 -*-
"""
GutenPwn — Destructive Attack Audit Engine
===================================================
Scans a target printer for all known IRREVERSIBLE / PHYSICAL-DAMAGE
vulnerabilities and produces a structured report.

Usage (CLI):
    python gpwn.py <target> --destructive-audit
    python gpwn.py <target> --destructive-audit --no-dry      # LIVE execution
...
def run_destructive_audit(
    ...
    lines += [
        _hdr("GutenPwn — Destructive Attack Audit"),
...
def main_destructive_audit(args) -> None:
    ...
    if not host:
        ...
        print(f"      Usage: python gpwn.py <target> --destructive-audit\n")
        sys.exit(1)
