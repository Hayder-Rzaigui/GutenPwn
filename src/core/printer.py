...
class printer(cmd.Cmd, object):
    ...
    def help_exit(self):
        """Exit the GutenPwn shell"""
        print()
        print("exit - Exit the GutenPwn shell")
        print("=" * 50)
        print("DESCRIPTION:")
        print("  Exits the GutenPwn shell and closes the connection to the printer.")
