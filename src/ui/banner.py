#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Unified GutenPwn banner (interactive + CLI)."""
...
def print_app_banner(*, quiet: bool = False, subtitle: str = '',
    ...
    title = f"GutenPwn v{__version__}"
    sub = subtitle or "Comprehensive Security Assessment Framework for Network Printers"
    meta = f"@{__release_date__} · @Hayder-Rzaigui"
