...
_log = logging.getLogger('GutenPwn.install_printer')
...
def _safe_name(host: str) -> str:
    ...
    return f"GutenPwn-{host.replace('.', '-')}"
    ...
    try:
        ...
        if rc == 0:
            return InstallResult(
                ...
                commands=['Get-Printer | Where-Object Name -like "*GutenPwn*"'],
            )
        return InstallResult(
