...
# -*- coding: utf-8 -*-
"""
GutenPwn — Smart Print Job Sender
=======================================
...
_log = logging.getLogger('GutenPwn.print_job')
...
def send_ipp(host: str, port: int, data: bytes,
    ...
    ipp_attrs  += _s('requesting-user-name',        'GutenPwn', 0x42)
