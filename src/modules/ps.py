...
# -*- coding: utf-8 -*-
"""
PostScript Module for GutenPwn
==========================================
Complete PostScript penetration testing module with 40+ commands

Based on PRET ps.py but massively enhanced for GutenPwn
"""
...
class ps(printer):
    """
    PostScript shell for GutenPwn - Complete Implementation
    """
    ...
    def do_help(self, arg):
        ...
        # Print header
        print()
        print("GutenPwn - PostScript Commands")
        print("=" * 70)
    ...
    def help_overlay_list(self):
        ...
        print("=" * 60)
        print("DESCRIPTION:")
        print("  Lists all available EPS overlay files bundled with GutenPwn.")
