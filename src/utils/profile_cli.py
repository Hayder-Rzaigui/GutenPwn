#!/usr/bin/env python3
"""CLI entry for gpwn-profile console script."""
...
def main(argv=None) -> int:
    ...
    if not args or args[0] in ("-h", "--help"):
        print("Usage: gpwn-profile [list|show|apply] [PROFILE]")
        print("  gpwn-profile apply modern          # default: 2020+ modules")
        print("  gpwn-profile apply full-depth      # all ~30 years")
        print("  gpwn-profile apply vendor-hp       # HP only")
        print("  gpwn-profile apply modern-vendor-hp")
        return 0
