...
```bash
python gpwn.py 192.168.0.152 --scan
```
...
```bash
python gpwn.py 192.168.0.152 --scan-ml
```
...
```bash
python gpwn.py 192.168.0.152 --scan --xpl
```
...
```bash
python gpwn.py 192.168.0.152 --scan --bruteforce
```
