...
> **Comprehensive Security Assessment Framework for Network Printers — v6.3.1**

Welcome to the GutenPwn documentation wiki. Select a page below for detailed documentation on each feature.
...
python gpwn.py --discover-local

# Passive fingerprint + CVE scan (no payloads)
python gpwn.py 192.168.1.100 --scan

# PJL interactive shell
python gpwn.py 192.168.1.100 pjl

# Credential brute-force with serial number
python gpwn.py 192.168.1.100 --bruteforce --bf-vendor epson --bf-serial XAABT77481

# Full attack matrix campaign (dry-run)
python gpwn.py 192.168.1.100 --attack-matrix

# List all exploit modules
python gpwn.py 192.168.1.100 --xpl-list
```

---

> Author: [@Hayder-Rzaigui](https://github.com/Hayder-Rzaigui) · [LinkedIn](https://linkedin.com/in/Hayder-Rzaigui) · [X/Twitter](https://x.com/Hayder-Rzaigui)
