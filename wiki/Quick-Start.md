...
```bash
python gpwn.py 192.168.0.152 --scan --no-nvd
```
...
```bash
python gpwn.py 192.168.0.152 --bruteforce \
...
```bash
python gpwn.py 192.168.0.152 auto
```
...
python gpwn.py 192.168.1.100 --scan --xpl
...
python gpwn.py --xpl-list

# Check API key status
python gpwn.py --check-config
```
