...
# Verify
python gpwn.py --version
# → GutenPwn Version 3.7.0 (2026-03-25)
```
...
python -m venv C:\Projetos-SafeLabs\dev\IoT\GutenPwn\.venv
C:\Projetos-SafeLabs\dev\IoT\GutenPwn\.venv\Scripts\activate
pip install -r requirements.txt
```
